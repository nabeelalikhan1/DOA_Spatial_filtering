...
plot(-10:5:10,20*log10(mse_MUSIC1),'r','LineWidth',3);
hold on;plot(-10:5:10,20*log10(mse_spatial_Filtering1),'b:','LineWidth',3);
hold on;plot(-10:5:10,20*log10(mse_FAST_DOA1),'k-','LineWidth',3);
hold on;plot(-10:5:10,20*log10(mse_c),'g-','LineWidth',3);

xlabel('Signal to Noise Ratio (dB)')
ylabel('Mean Squared Error (dB)')
legend('Conventaional time-domain MUSIC algorithm with spatial filtering','The Proposed Method','DOA estimation based on FAST-IF Estimator','DOA Estimation based on ADTFD based IF estimator '); 
